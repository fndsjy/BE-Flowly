...
export declare class OnboardingMaterialController {
    ...
    static recordMaterialOpen(req: Request, res: Response, next: NextFunction): Promise<void>;
    static downloadCustomerLearningFile(req: Request, res: Response, next: NextFunction): Promise<void>;
