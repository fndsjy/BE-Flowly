...
export class AccessRoleController {
  static async create(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const response = await AccessRoleService.create(
        payload.userId,
        req.body as CreateAccessRoleRequest
      );
  ...
  static async update(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const payload = verifyToken(token);
      const response = await AccessRoleService.update(
        payload.userId,
        req.body as UpdateAccessRoleRequest
      );
  ...
  static async softDelete(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const payload = verifyToken(token);
      const response = await AccessRoleService.softDelete(
        payload.userId,
        req.body as DeleteAccessRoleRequest
      );
