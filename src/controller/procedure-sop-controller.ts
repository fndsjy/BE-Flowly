...
import type {
  CreateProcedureSopRequest,
  UpdateProcedureSopRequest,
  DeleteProcedureSopRequest,
...
export class ProcedureSopController {
  static async create(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const response = await ProcedureSopService.create(
        payload.userId,
        req.body as CreateProcedureSopRequest
      );
  ...
  static async update(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const payload = verifyToken(token);
      const response = await ProcedureSopService.update(
        payload.userId,
        req.body as UpdateProcedureSopRequest
      );
  ...
  static async softDelete(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const payload = verifyToken(token);
      const response = await ProcedureSopService.softDelete(
        payload.userId,
        req.body as DeleteProcedureSopRequest
      );
  ...
  static async list(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const response = await ProcedureSopService.list(
        payload.userId,
