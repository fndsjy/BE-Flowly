...
import { AttendanceFaceController } from "../controller/attendance-face-controller.js";
...
v1.get("/attendance-face/employees", AttendanceFaceController.listEmployees);
v1.get("/attendance-face/logs", AttendanceFaceController.listLogs);
v1.post("/attendance-face/enroll", AttendanceFaceController.enroll);
v1.post("/attendance-face/match-profile", AttendanceFaceController.matchProfile);
v1.post("/attendance-face/scan-success", AttendanceFaceController.recordSuccess);
v1.post("/attendance-face/scan-failure", AttendanceFaceController.recordFailure);
...
v1.get(
  ...
  OnboardingController.listEmployeePortalMonitoring
);
...
v1.post(
  "/onboarding/cancel-assignment",
  OnboardingController.cancelEmployeeOnboarding
);
v1.post(
  "/onboarding/exam/request-start",
  OnboardingController.requestExamStartApproval
);
...
v1.post("/onboarding/exam/reset-attempt", OnboardingController.resetExamAttempt);
...
v1.get(
  "/onboarding-stage/portal-learning",
  OnboardingStageController.listPortalLearning
);
v1.get(
...
v1.get(
  "/onboarding-stage/portal-learning/file",
  OnboardingMaterialController.downloadCustomerLearningFile
);
v1.post(
...
v1.post(
  "/onboarding-stage/portal-learning/file-open",
  OnboardingStageController.recordPortalLearningFileOpen
);
...
v1.get(
  "/notification-template/manual-recipients",
  NotificationTemplateController.listManualRecipients
);
v1.post(
  "/notification-template/manual-send",
  NotificationTemplateController.sendManual
);
v1.post(
