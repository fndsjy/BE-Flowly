...
const buildOnboardingNotificationContext = (params: {
  ...
  return {
    ...
    username,
    temporaryPassword:
      params.temporaryPassword || resolveTemporaryPassword(params.employee.Password),
...
export class OnboardingService {
  ...
  static async listEmployeeSummary(
    ...
    return Array.from(latestByEmployee.values())
      ...
      .filter(
        (item): item is EmployeeOnboardingSummaryResponse => item !== null
      )
  ...
  static async startEmployees(
    ...
    const createNotificationOutboxId =
      runtimeTemplates.length > 0 ? await generateNotificationOutboxId() : null;
    const actorId = trimAuditActor(requesterUserId);
