...
import {
  type CreateJabatanRequest,
  type UpdateJabatanRequest,
  type DeleteJabatanRequest,
  toJabatanResponse,
  toJabatanListResponse
} from "../model/jabatan-model.js";

export class JabatanService {
  /* ---------- CREATE ---------- */
  static async create(requesterId: string, reqBody: CreateJabatanRequest) {
  ...
  /* ---------- UPDATE ---------- */
  static async update(requesterId: string, reqBody: UpdateJabatanRequest) {
    ...
    if (req.jabatanLevel !== undefined && req.jabatanLevel !== existing.jabatanLevel) {
      ...
      const updated = await prismaFlowly.$transaction(async (tx) => {
        ...
        for (const level of levels) {
          ...
          if (level.jabatanLevel < minLevel) minLevel = level.jabatanLevel;
          if (level.jabatanLevel > maxLevel) maxLevel = level.jabatanLevel;
        }
  ...
  /* ---------- DELETE ---------- */
  static async softDelete(requesterId: string, reqBody: DeleteJabatanRequest) {
