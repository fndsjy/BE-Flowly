...
import {
  type CreateFishboneCauseRequest,
  type UpdateFishboneCauseRequest,
  type DeleteFishboneCauseRequest,
  toFishboneCauseResponse,
  toFishboneCauseListResponse,
...
const getCauseSnapshot = (record: Record<string, unknown>) =>
  pickSnapshot(record, FISHBONE_CAUSE_AUDIT_FIELDS as unknown as string[]);
...
export class FishboneCauseService {
  static async create(requesterId: string, reqBody: CreateFishboneCauseRequest) {
  ...
  static async update(
    requesterId: string,
    reqBody: UpdateFishboneCauseRequest
  ) {
    ...
    const updateData: Prisma.FishboneCauseUpdateInput = {
    ...
    const changes = buildChanges(
      ...
      FISHBONE_CAUSE_AUDIT_FIELDS as unknown as string[]
    );
  ...
  static async softDelete(
    requesterId: string,
    reqBody: DeleteFishboneCauseRequest
  ) {
  ...
  static async list(
    ...
    const whereClause: Prisma.FishboneCauseWhereInput = {
      isDeleted: false,
