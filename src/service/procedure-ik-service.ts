...
import {
  type CreateProcedureIkRequest,
  type UpdateProcedureIkRequest,
  type DeleteProcedureIkRequest,
  toProcedureIkResponse,
  toProcedureIkListResponse,
...
export class ProcedureIkService {
  static async create(requesterId: string, reqBody: CreateProcedureIkRequest) {
  ...
  static async update(requesterId: string, reqBody: UpdateProcedureIkRequest) {
  ...
  static async softDelete(requesterId: string, reqBody: DeleteProcedureIkRequest) {
