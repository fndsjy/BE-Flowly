...
import {
  ...
  type DeleteOrgStructureRequest,
  toOrgStructureResponse,
  toOrgStructureListResponse
} from "../model/orgstructure-model.js";
...
export class OrgStructureService {
   ...
   * CREATE
   * ------------------------------------------ */
  static async create(requesterId: string, reqBody: CreateOrgStructureRequest) {
