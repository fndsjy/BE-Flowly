...
export const resolveAttendanceAccessLevel = async (
  requesterUserId: string
): Promise<AttendanceAccessLevel> => {
  ...
  let finalLevel: AttendanceAccessLevel | null = null;
...
export const ensureAttendanceReadAccess = async (requesterUserId: string) => {
  await resolveAttendanceAccessLevel(requesterUserId);
};

export const ensureAttendanceCrudAccess = async (requesterUserId: string) => {
